...
--  Version: 2.1.1 (GITHUB READY - LOADSTRING COMPATIBLE)
-- ═══════════════════════════════════════════════════════════

-- Proteção para múltiplas execuções
if game:GetService("CoreGui"):FindFirstChild("MirageHubPro") or game:GetService("Players").LocalPlayer:FindFirstChild("PlayerGui"):FindFirstChild("MirageHubPro") then
        ...
        pcall(function()
            ...
            if remotes then
                ...
                if damageRemote and damageRemote:IsA("RemoteEvent") then
                    -- Calcula dano real baseado na porcentagem
                    local damageAmount = 999999 -- valor alto se for 100%
...
local infoText = createInstance("TextLabel", {
    ...
    BackgroundTransparency = 1,
    Text = "• Mob Aura: Kills wolves, bears, cultists, etc.\n• Tree Aura: Destroys trees for wood farming\n• Damage: 100% = instant kill/destroy\n• Range: 0-2000 studs (adjust as needed)\n• Press RightShift to toggle GUI\n\nNote: Lower damage for farming, 100% for instant kills",
    TextColor3 = CONFIG.Colors.TextSecondary,
    Font = Enum.Font.Gotham,
    TextSize = 10,
    TextXAlignment = Enum.TextXAlignment.Left,
