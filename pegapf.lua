...
-- SECTIONS
-- Colocamos as funções de Aura (Mob/Tree) dentro da aba "Combat"
local CombatSection = createSection("Combat", "Mob and Tree aura tools (Mob Aura, Tree Aura)", UDim2.new(0, 12, 0, 52), 1)
local InfoSection = createSection("Info", "Current status and statistics", UDim2.new(0, 12, 0, 280), 1)

-- MOB AURA CONTROLS (dentro da aba Combat)
local mobToggleFrame, mobToggleBtn = createToggle("Enable Mob Aura", CombatSection, false)
local mobRangeSliderFrame, mobRangeSliderLabel = createSlider("Range (studs)", 0, 2000, 10, CombatSection, mobAuraRange, function(value)
    mobAuraRange = value
    debugPrint("Mob Aura Range:", value)
end)
local mobDamageSliderFrame, mobDamageSliderLabel = createSlider("Damage (%)", 1, 100, 1, CombatSection, mobAuraDamage, function(value)
    mobAuraDamage = value
...
-- TREE AURA CONTROLS (dentro da aba Combat)
local treeToggleFrame, treeToggleBtn = createToggle("Enable Tree Aura", CombatSection, false)
local treeRangeSliderFrame, treeRangeSliderLabel = createSlider("Range (studs)", 0, 2000, 10, CombatSection, treeAuraRange, function(value)
    treeAuraRange = value
    debugPrint("Tree Aura Range:", value)
end)
local treeDamageSliderFrame, treeDamageSliderLabel = createSlider("Damage (%)", 1, 100, 1, CombatSection, treeAuraDamage, function(value)
...
local infoText = createInstance("TextLabel", {
    ...
    Text = "• Mob Aura: Mata mobs automaticamente (wolves, bears, cultists...)\n" ..
           ...
           "• Range: Distância em studs para aplicar o efeito\n" ..
           "• Use a aba 'Combat' para controlar Mob Aura e Tree Aura",
    TextColor3 = CONFIG.Colors.TextSecondary,
    Font = Enum.Font.Gotham,
    TextSize = 10,
    TextXAlignment = Enum.TextXAlignment.Left,
