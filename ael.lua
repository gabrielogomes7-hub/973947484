...
-- 1) tenta CoreGui (usado por muitos executores)
-- 2) se falhar, usa PlayerGui
local function parentScreenGui(gui)
    local ok = false
    -- Tenta CoreGui (apenas se permitido)
    pcall(function()
